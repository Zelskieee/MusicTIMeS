...
<head>
    ...
    <title>Email Verification for Forgot Password</title>
...
<form id="otp-form" action="verify_otp_change_password.php" method="post" autocomplete="off">
    <div class="image-container">
        <img src="./image/logo.png" alt="Login Image" width="300px" height="100px">
    </div>
    <h2>Email Verification for Forgot Password</h2>
    <h3>OTP Code has been sent to <span style="color: grey; font-weight: bold; font-size: 18px;">@
    <?php
        if (isset($_GET['customer_email']) && !empty($_GET['customer_email'])) {
            echo htmlspecialchars($_GET['customer_email']);
        } else {
            echo "Invalid email";
        }
    ?></span></h3>
